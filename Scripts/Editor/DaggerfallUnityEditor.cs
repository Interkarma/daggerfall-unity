                    ...
                    GUILayoutHelper.Horizontal(() =>
                    {
                        ...
                        if (GUILayout.Button("Import"))
                        {
                            ...
                            if (propBlockName.stringValue.EndsWith(".RMB"))
                                ...
                                GameObjectHelper.CreateRDBBlockGameObject(propBlockName.stringValue, true, null, DFRegion.DungeonTypes.HumanStronghold, 0, dfUnity.Option_DungeonBlockPrefab);
                        }
                    });
