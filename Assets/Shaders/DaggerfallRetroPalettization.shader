...
{
  ColorMatch best = buildColorMatch(fixed4(134.0/255,103.0/255,65.0/255,1.0));
  ColorMatch other;
...
{
  ColorMatch best = buildColorMatch(fixed4(45.0/255,72.0/255,72.0/255,1.0));
  ColorMatch other;
...
{
  ColorMatch best = buildColorMatch(fixed4(44.0/255,44.0/255,44.0/255,1.0));
  ColorMatch other;
...
{
  ColorMatch best = buildColorMatch(fixed4(23.0/255,23.0/255,42.0/255,1.0));
  ColorMatch other;
