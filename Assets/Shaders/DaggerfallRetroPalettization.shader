...
ColorMatch findColorLLL() // 36 colors
{
...
ColorMatch findColorLLR() // 36 colors
{
  ColorMatch best = buildColorMatch(fixed4(255.0/255,185.0/255,98.0/255,1.0));
  ColorMatch other;
...
{
  fixed diff = targetColor.g - 187.0/255;
  if (diff >= 0)
  {
...
ColorMatch findColorLRL() // 36 colors
{
  ColorMatch best = buildColorMatch(fixed4(127.0/255,77.0/255,106.0/255,1.0));
  ColorMatch other;
...
ColorMatch findColorLRR() // 35 colors
{
  ColorMatch best = buildColorMatch(fixed4(0.0/255,0.0/255,103.0/255,1.0));
  ColorMatch other;
...
ColorMatch findColorRLL() // 36 colors
{
  ColorMatch best = buildColorMatch(fixed4(139.0/255,83.0/255,43.0/255,1.0));
  ColorMatch other;
  ...
  if (other.minDistSqr < best.minDistSqr) best = other;
  other = buildColorMatch(fixed4(152.0/255,93.0/255,63.0/255,1.0));
  if (other.minDistSqr < best.minDistSqr) best = other;
...
ColorMatch findColorRLR() // 36 colors
{
  ColorMatch best = buildColorMatch(fixed4(137.0/255,112.0/255,66.0/255,1.0));
  ColorMatch other;
...
{
  fixed diff = targetColor.r - 138.0/255;
  if (diff >= 0)
  {
...
ColorMatch findColorRRL() // 35 colors
{
  ColorMatch best = buildColorMatch(fixed4(43.0/255,56.0/255,39.0/255,1.0));
  ColorMatch other;
...
ColorMatch findColorRRR() // 37 colors
{
  ColorMatch best = buildColorMatch(fixed4(40.0/255,47.0/255,40.0/255,1.0));
  ColorMatch other;
...
{
  fixed diff = targetColor.r - 40.0/255;
  if (diff >= 0)
  {
...
{
  fixed diff = targetColor.r - 67.0/255;
  if (diff >= 0)
  {
