    ...
    public class BirdSpawner : MonoBehaviour
    {
        ...
        IEnumerator SpawnBirds()
        {
            ...
            while (true)
            {
                ...
                main.startRotation = Mathf.PI / 180 * birdSpawn[spawnID].transform.eulerAngles.y; //Rotate the bird "sprites" so that they are facing the direction that the fly, sprite rotation uses radians so some math is required
                main.startSpeed = Random.Range(20, 40); //Random speed
