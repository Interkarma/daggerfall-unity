...
namespace Game.Pet
{
    public class SetupDemoEnemy : MonoBehaviour
    {
        ...
        public MobileReactions EnemyReaction = MobileReactions.Custom;
        ...
        public void ApplyEnemySettings(MobileGender gender)
        {
            ...
            if (dfMobile != null)
            {
                ...
                // Setup sounds
                EnemySounds enemySounds = GetComponent<DaggerfallWorkshop.Game.EnemySounds>();
                if (enemySounds)
                {
        ...
        /// Change enemy settings and configure in a single call.
        /// </summary>
        public void ApplyEnemySettings(EntityTypes entityType, int careerIndex, MobileGender gender,
