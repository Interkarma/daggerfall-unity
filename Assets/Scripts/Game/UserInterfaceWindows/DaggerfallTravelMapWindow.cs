    ...
    public class DaggerfallTravelMapWindow : DaggerfallPopupWindow
    {
        ...
        public override void Update()
        {
            ...
            if (RegionSelected)
            {
                ...
                if (Input.GetKeyDown(DaggerfallMessageBox.ShortcutKey[DaggerfallMessageBox.MessageBoxButtons.TravelMapList]))
                {
                ...
                else if (Input.GetKeyDown(DaggerfallMessageBox.ShortcutKey[DaggerfallMessageBox.MessageBoxButtons.TravelMapFind]))
