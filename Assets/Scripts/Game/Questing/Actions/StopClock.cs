...
{
    /// <summary>
    /// This action stops the timer without triggering any tasks.
    /// </summary>
    public class StopClock : ActionTemplate
    {
        public string clockName;

        public override string Pattern
        {
            get { return @"stop timer (?<clockName>[a-zA-Z0-9_.]+)"; }
        }

        public StopClock(Quest parentQuest)
            : base(parentQuest)
        {
        }
