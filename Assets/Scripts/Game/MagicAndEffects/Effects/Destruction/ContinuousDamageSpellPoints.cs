...
namespace DaggerfallWorkshop.Game.MagicAndEffects.MagicEffects
{
    ...
    public class ContinuousDamageSpellPoints : IncumbentEffect
    {
        public override void SetProperties()
        {
            ...
            properties.DurationCosts = MakeEffectCosts(40, 8, 2, 68);
            properties.MagnitudeCosts = MakeEffectCosts(40, 28, 2, 48);
        }
        ...
        public override void MagicRound()
        {
            ...
            entityBehaviour.DamageMagickaFromEffect(this, magnitude);
