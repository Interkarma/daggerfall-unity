...
namespace DaggerfallWorkshop.Game
{
    ...
    public class DaggerfallUI : MonoBehaviour
    {
        ...
        void DisplayStatusInfo()
        {
            ...
            statusBox.KeyCodesThatCloseCurrentMessageBox = InputManager.Instance.GetBindings(InputManager.Actions.Status);
            ...
            healthBox.KeyCodesThatCloseCurrentMessageBox = InputManager.Instance.GetBindings(InputManager.Actions.Status);
