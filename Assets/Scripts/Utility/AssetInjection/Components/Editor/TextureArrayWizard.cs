...
namespace DaggerfallWorkshop.Utility.AssetInjection
{
    ...
    public sealed class TextureArrayWizard : ScriptableWizard
    {
        ...
        public string Folder = "Assets/Untracked/TexArrays";
        ...
        [Tooltip("Textures to be included in the array in the required order.")]
        ...
        void OnWizardCreate()
        {
            ...
            AssetDatabase.CreateAsset(textureArray, Path.Combine(Folder, Name + ".asset"));
        }
