...
namespace DaggerfallWorkshop.Game
{
	...
	public class RealGrass : MonoBehaviour
	{
        ...
        private void Awake()
		{
			...
			//All the settings
			detailPrototype[0].minHeight = 0.75f;
			detailPrototype[0].minWidth = 0.75f;
			detailPrototype[0].maxHeight = 1.0f;
			detailPrototype[0].maxWidth = 1.0f;
			detailPrototype[0].noiseSpread = 0.5f;
			detailPrototype[0].dryColor = Color.white;
			detailPrototype[0].healthyColor = Color.white;
